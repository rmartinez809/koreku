...
const Binder = ({ setUserCollection, userID, loading, setLoading }) => {
    ...
    return (
        <Fragment>
            <Header />
            <div className="modal fade" id="confirmDeleteModal" tabIndex="-1"  aria-labelledby="confirmDeleteModal" aria-hidden="true">
                     ...
                     <div className="modal-content">
                        ...
                        <div className="modal-body">
                         ...
                         <div className="modal-footer">
                            <button type="button"
                                className="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel
                            </button>
                            <button type="button"
        ...
        <div className="binder-container container-padding">
            <h3>{collectionName}
            <button className="delete-col-btn"
